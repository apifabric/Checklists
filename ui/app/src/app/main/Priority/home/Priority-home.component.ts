...
@Component({
  selector: 'Priority-home',
  templateUrl: './Priority-home.component.html',
  styleUrls: ['./Priority-home.component.scss']
})
export class PriorityHomeComponent implements AfterViewInit {
