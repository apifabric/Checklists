...
@Component({
  selector: 'TaskTag-home',
  templateUrl: './TaskTag-home.component.html',
  styleUrls: ['./TaskTag-home.component.scss']
})
export class TaskTagHomeComponent implements AfterViewInit {
