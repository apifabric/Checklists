...
@Component({
  selector: 'Attachment-home',
  templateUrl: './Attachment-home.component.html',
  styleUrls: ['./Attachment-home.component.scss']
})
export class AttachmentHomeComponent implements AfterViewInit {
