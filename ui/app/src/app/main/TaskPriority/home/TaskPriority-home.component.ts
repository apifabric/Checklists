...
@Component({
  selector: 'TaskPriority-home',
  templateUrl: './TaskPriority-home.component.html',
  styleUrls: ['./TaskPriority-home.component.scss']
})
export class TaskPriorityHomeComponent implements AfterViewInit {
