...
@Component({
  selector: 'Checklist-home',
  templateUrl: './Checklist-home.component.html',
  styleUrls: ['./Checklist-home.component.scss']
})
export class ChecklistHomeComponent implements AfterViewInit {
