...
resourcename="checklists"  # lower case, only
resourcegroup="checklists_rg"
...
# git clone https://github.com/apilogicserver/checklists.git
# cd checklists
...
az group create --name checklists_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group checklists_rg --sku S1 --is-linux
az container create --resource-group checklists_rg --name checklists --image apilogicserver/checklists:latest --dns-name-label checklists --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//checklists.westus.azurecontainer.io:5656'
